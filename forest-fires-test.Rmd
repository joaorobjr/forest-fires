...
### TAVG, TAVG15d, TMax and TMin

```{r tavg-ratings,echo = FALSE, fig.align= "center", fig.cap= "\\label{causes-ratings}GeomPoint of Average Temperature by month"}
ggplot(ffires.full) + 
  geom_boxplot(mapping = aes(x = tavg, y = month(alert_date, label = T)), size = 1.0, colour = "red") +
  labs(x="TAVG", y="Months") + 
  coord_flip()
```
