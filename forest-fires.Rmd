...
A cleaning was made on lat and lon variables to remove some characters and change to "". It was necessary for the convertion from GPS coordinate to decimals.
```{r echo=FALSE}
