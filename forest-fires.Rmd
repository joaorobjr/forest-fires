...
```{r nb_model, eval=FALSE, echo=T, include=FALSE}
...
```{r lda_model, eval=FALSE, include=FALSE}

```

### Penalized Discriminant Analysis

```{r pda_model, eval=FALSE, include=FALSE}
...
```{r tb_model, eval=FALSE, include=FALSE}

```

### Decision Tree

```{r tree_model, eval=FALSE, include=FALSE}
